...
final class EditVacancyViewModel: EditVacancyFlowState {
    ...
    func getInputModel() -> EditVacancyInputModel {
        EditVacancyInputModel(title: vacancy.title,
                              ...
                              applied: vacancy.appliedNumber != nil ? "\(vacancy.appliedNumber ?? 0) человек уже откликнулось" : nil,
                              looking: vacancy.lookingNumber != nil ? "\(vacancy.lookingNumber ?? 0) человека сейчас смотрят" : nil,
